...
public class PersonControllerTest {
    ...
    void testGivenListOfPersons_WhenFindAllPersons_thenReturnPersonsList() throws JsonProcessingException, Exception{
        ...
        persons.add(person);
        persons.add(new Person("Oscar","Braga","Rio de Janeiro - Brasil","Male","oscar@gmail.com"));
    ...
    void testGivenUnexistentPerson_WhenUpdate_thenReturnNotFound() throws JsonProcessingException, Exception{
        ...
        // When / Act
        var updatePerso =new Person("Oscar","Braga","Rio de Janeiro - Brasil","Male","oscar@gmail.com");

        ResultActions response = mockMvc.perform(put("/person")
                .contentType(MediaType.APPLICATION_JSON)
                .content(mapper.writeValueAsString(updatePerso)));
