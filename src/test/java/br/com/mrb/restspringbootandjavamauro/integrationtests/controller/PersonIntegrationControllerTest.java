...
public class PersonIntegrationControllerTest extends AbstractIntegrationTest {
    ...
    void integrationTestGivenPersonObject_when_UpdateOnePerson_ShouldReturnAUpdatedPersonObject() throws JsonMappingException, JsonProcessingException  {
        ...
        assertEquals("Braga", updatedPerson.getLastName());
        assertEquals("Rio de Janeiro - Brasil", updatedPerson.getAddress());
    ...
    void integrationTestGivenPersonObject_when_findById_ShouldReturnAPersonObject() throws JsonMappingException, JsonProcessingException {
        ...
        assertEquals("Braga", foundPerson.getLastName());
        assertEquals("Rio de Janeiro - Brasil", foundPerson.getAddress());
    ...
    void integrationTest_when_findAll_ShouldReturnAPersonsList() throws JsonMappingException, JsonProcessingException {
        ...
        Person anotherPerson =  new Person("Gabriela","Rodriguez","Uberlândia - Minas Gerais - Brasil","Female","gabi@erudio.com.br");
        ...
        assertEquals("Braga", foundPersonOne.getLastName());
